...
const PrivacyPage = () => {
  return (
    <Layout>
      <Head>
        <title>Privacy Policy - Palladians</title>
      </Head>
      <main
        className={container({
          paddingY: '8rem',
      ...
      >
        <h1 className={box({ fontSize: '2rem', fontWeight: 'semibold' })}>
          Privacy Policy
        </h1>
        ...
        <h2 className={box({ fontSize: '1.5rem', fontWeight: 'semibold' })}>
          Interpretation
        </h2>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to MRCNK Tomasz
              Marciniak, Teofila Mateckiego 20/36, 60-689 Poznan, Poland.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Palladians, accessible from{' '}
              <a
        ...
        <h3 className={box({ fontSize: '1.25rem', fontWeight: 'semibold' })}>
          Personal Data
        </h3>
        <p>
        ...
        <ul>
          <li>
            <p>By email: team@palladians.xyz</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{' '}
              <a
                href="https://palladians.xyz/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://palladians.xyz/contact
              </a>
            </p>
          </li>
        </ul>
